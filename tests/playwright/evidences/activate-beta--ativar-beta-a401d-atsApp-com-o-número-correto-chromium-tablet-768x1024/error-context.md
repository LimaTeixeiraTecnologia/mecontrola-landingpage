...
- Name: activate-beta.spec.ts >> /ativar-beta >> ativação automática com sucesso — mostra CTA WhatsApp com o número correto
- Location: tests/playwright/activate-beta.spec.ts:14:3
...
Locator: locator('#activate-beta-wa-btn')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('#activate-beta-wa-btn')
